...
class get_most_color {

    var $PREVIEW_WIDTH = 150;
    var $PREVIEW_HEIGHT = 150;
    var $error;

    static public function trace_part($img, $count = 20, $reduce_brightness = true, $reduce_gradients = true, $delta = 16) {

//        return ['0' => '', '1' => ''];

        return (new self())->Get_Color(\router\router_roll::get_document_root() . $img, $count, $reduce_brightness, $reduce_gradients, $delta);
