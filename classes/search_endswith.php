...
class search_endswith {

    static public function get_search_data_in_table_loop(string $table, string $items_needed, array $value_pair, int $offset = null, int $limit = 10, string $order_by = null, bool $or = true, string $sql_query = null, string $order_dir = null) {
