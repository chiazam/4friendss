...
class location_clearer {
    ...
    static public function state_true(string $state, string $country) {
        ...
        if (!isset($states_cont_array[$country])) {
            return false;
        } else {

            if (!in_array($state, $states_cont_array[$country])) {

                if (empty($states_cont_array[$country]) && empty(trim($state))) {
                    return true;
                } else {
                    return false;
                }
