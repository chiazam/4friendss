...
if (!get_checker::check_isset_get(["bic", "qic"])) {

    new returner\final_returner_json(['permission' => 'denied due to insuffiecient credentials']);
}

if (checkist\num_of_data_in_table::num_of_data_in_table("users", "*", ["q" => $_GET["qic"], "b" => $_GET["bic"]]) > 0) {

    $data = checkist\get_data_in_table::get_data_in_table("users", "*", ["q" => $_GET["qic"], "b" => $_GET["bic"]]);
