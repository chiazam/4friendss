...
if (!get_checker::check_isset_get(["qis", "bis"])) {

    new returner\final_returner_json(['permission' => 'denied due to insuffiecient credentials']);
}

if (checkist\num_of_data_in_table::num_of_data_in_table("users", "*", ["b" => $_GET["bis"], "q" => $_GET["qis"]]) > 0) {

    $data = checkist\get_data_in_table::get_data_in_table("users", "*", ["b" => $_GET["bis"], "q" => $_GET["qis"]]);
