...
$blogs = exp_un\un_expire_times_post::get_times_unexpired_main($_session_['g'], $_session_['q'], $_session_['b'], $_session_['r'], '../../', true, 'blog', $offset, $limit, false);
...
if (!isset($blogs['none'])) {
    ...
    new returner\final_returner_json(['message' => ['blog' => $blogs]]);
} else {

    $blogs = exp_un\un_expire_times_post::get_times_unexpired_main($_session_['g'], $_session_['q'], $_session_['b'], $_session_['r'], '../../', true, 'blog', $offset, $limit, true);
