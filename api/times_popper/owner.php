...
if (!get_checker::check_isset_get(["by_g"])) {

    new returner\final_returner_json(['permission' => 'denied due to insuffiecient credentials']);
}

if (checkist\num_of_data_in_table::num_of_data_in_table("users", "*", ["g" => $_GET["by_g"]]) > 0) {

    $data = checkist\get_data_in_table::get_data_in_table("users", "*", ["g" => $_GET["by_g"]]);
    ...
    new returner\final_returner_json(['mis_conduct' => 'wrong credentials', 'field' => 'by_g']);
}
