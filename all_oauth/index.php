...
<html class='min-height-100-cent display-flex'>
    <head>
        ...
        <script> const my_our_platforms = <?php echo json_encode($_my_platform); ?>; </script>

        <script src="<?php echo $api_path; ?>extra_script/folder_static.php?files[]=friends_js_lib/li1.js&type=js"></script>

        <script src="<?php echo $api_path; ?>extra_script/folder_static.php?folders[]=static__front/js/loggedin&folders[]=static__front/js/loggedout&folders[]=static__front/js/worker_consumer&folders[]=static__front/js/worker_shotter&type=js"></script>
    ...
    <body id="main_body_hanger" class='min-height-100-cent width-100-cent lighter'>
        ...
        <script><?php echo compress_js("./js/start_oauth.js"); ?></script>
