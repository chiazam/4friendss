        ...
        setTimeout(function () {
            ...
            if ((scroll === false) && ($(bis_bis_id) !== null)) {
                ...
                if ($(bis_bis_id).childElementCount < 2) {
                    ...
                    $(`${bis_bis_id}_sroller_right`).style.display = 'none';

                    $(`${bis_bis_id}_sroller_left`).style.display = 'none';
...
(function () {
    ...
    funcs.sentiment_analysis_templater = function (senti_obj) {
        ...
        let template = `<section class="display-flex min-width-100-cent max-width-100-cent border-box align-items-center padding-2-px">
                ...
                <section class="width-fit-content display-flex line-height-initial align-items-center border-radius-5px padding-2-px margin-left-5-px margin-bottom-2-px"> compound : ${(parseInt(senti_obj.compound))*100}% </section>
           
                <section class="width-fit-content display-flex line-height-initial align-items-center border-radius-5px padding-2-px margin-left-5-px margin-bottom-2-px"> postive : ${(parseInt(senti_obj.pos))*100}% </section>
           
                <section class="width-fit-content display-flex line-height-initial align-items-center border-radius-5px padding-2-px margin-left-5-px margin-bottom-2-px"> negative : ${(parseInt(senti_obj.neg))*100}% </section>
           
                <section class="width-fit-content display-flex line-height-initial align-items-center border-radius-5px padding-2-px margin-left-5-px margin-bottom-2-px"> neutral : ${(parseInt(senti_obj.neu))*100}% </section>

        </section> 
        
        `;

        return `<section class="padding-5-px padding-top-0-px padding-bottom-0-px border-box">
       
        <section class="padding-10-px border-1px-solid border-radius-5px padding-top-0-px padding-bottom-0-px border-box margin-bottom-5-px">

        <!--<section class="padding-5-px font-weight-bold"> Sentiment analysis </section>-->
        
            ${funcs.scroll_amber_wawerteer_fdtg(template, true, 'smaller_scroll_butt', 10, '', `margin-top-5-px margin-bottom-5-px flex-1 max-width-100-cent`)} 
    ...
    if(!hashtag.hasOwnProperty('none')||!tag.hasOwnProperty('none')){
       ...
       if(!hashtag.hasOwnProperty('none')){
        ...
        lib._looper_challenge(hashtag, function (element) {
            ...
            hashtag_list+=`<section class="width-fit-content display-flex line-height-initial align-items-center border-radius-5px padding-2-px margin-left-5-px margin-bottom-2-px cursor-pointer hover-text-decoration-underline color-fb-blue hover-background-twitter" onclick="trigger_search('search_holder', '${element}','post');"> #${element} </section>`;
       ...
       if(!tag.hasOwnProperty('none')){
        ...
        lib._looper_challenge(tag, function (element) {
            ...
            tag_list+=`<section class="width-fit-content display-flex line-height-initial align-items-center border-radius-5px padding-2-px margin-left-5-px margin-bottom-2-px cursor-pointer hover-text-decoration-underline color-fb-blue hover-background-twitter margin-bottom-5-px" onclick="trigger_anchor('${element}')"> @${element} </section>`;
       ...
       tag_template=`<section class="padding-5-px padding-top-0-px padding-bottom-0-px border-box">
       
       <section class="padding-10-px border-1px-solid border-radius-5px padding-top-0-px padding-bottom-0-px border-box">

       <!--<section class="padding-5-px font-weight-bold"> Hashtags and Mentions list </section>-->
       
        <section> ${funcs.scroll_amber_wawerteer_fdtg(`<section class="padding-5-px padding-left-0-px padding-right-0-px display-flex min-width-100-cent max-width-100-cent">${hashtag_tag_template}</section>`, true, 'smaller_scroll_butt')}</section>
