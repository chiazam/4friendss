...
(function () {
    ...
    states.states_list = {
        ...
        "British Indian Ocean Territory": [].sort(),
        ...
        "Virgin Islands (British)": [].sort(),
        "Virgin Islands (U.S.)": [].sort(),
        "Brunei": [
            "Belait",
            "Brunei-Muara",
            "Temburong",
        ...
        "Christmas Island": [].sort(),
        "Cocos (Keeling) Islands": [].sort(),
        "Colombia": [
            "Amazonas",
            "Antioquia",
            "Arauca",
        ...
        "French Guiana": [].sort(),
        "French Polynesia": [].sort(),
        "French Southern and Antarctic Lands": [].sort(),
        "Gabon": [
            "Estuaire",
            "Haut-Ogooué",
            "Moyen-Ogooué",
        ...
        "Heard Island and McDonald Islands": [].sort(),
        "Holy See": [].sort(),
        "Honduras": [
            "Atlántida",
            "Choluteca",
        ...
        "Saint Martin": [].sort(),
        "Saint Pierre and Miquelon": [].sort(),
    ...
    states.send_states = function (country) {

        let states_list_formatted = ``;

        if (states.states_list.hasOwnProperty(country)) {

            if(states.states_list[country].length > 0){

                for (let q = 0; q < states.states_list[country].length; q++) {
    
                    states_list_formatted += `<section style="font-size:16px;" data-value="${states.states_list[country][q]}" class="butt_selector">${states.states_list[country][q]}</section>`;
    
                }
                
            }else{

                states_list_formatted = `<section style="font-size:16px; padding:5px; text-align:center;"> ${country} has no states yet, so leave it blank </section> `;

            }
    
                return states_list_formatted;
