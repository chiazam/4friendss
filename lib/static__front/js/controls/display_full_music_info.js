...
!function () {
    ...
    funcs.music_info_display_infoo = function (obj) {
        ...
        <section class='overflow-hidden width-100-cent height-fit-content border-1px-solid border-right-none border-left-none border-box display-flex flex-column'>
            ...
            <section class='display-flex width-90-cent margin-auto align-items-center justify-content-center width-100-cent margin-top-5-px border-box padding-10-px border-1px-solid border-radius-5px padding-top-0-px padding-bottom-0-px border-box margin-bottom-5-px'>${funcs.display_capter_namer_random(audio__info.uploader, false, false)}</section>
