...
funcs.start_post_full_main = function (element, container_id, suffix) {
...
lib.add_class('padding-5-px', `photo_post_wegbet_${element.key_link}_${suffix}`);
        ...
        funcs.photo_switcher_content_maker(element.images, `photo_post_wegbet_${element.key_link}_${suffix}`, suffix);
